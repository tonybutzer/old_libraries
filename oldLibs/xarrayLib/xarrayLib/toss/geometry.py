...
class GeoBox(object):
    ...
    def __init__(self, width, height, affine, crs):
        ...
        # print("TONY GeoBox self.extent" , self.extent)
    ...
    def from_geopolygon(cls, geopolygon, resolution, crs=None, align=None):
        ...
        # print("TONY from geopoly - align" , align)
        if crs is None:
            crs = geopolygon.crs
        else:
        ...
        # print("TONY from geopoly - offx offy boundin_box", offx, offy, bounding_box)
    ...
    def coordinates(self):
        ...
        # print("Tony geobox self.crs.dimensions, self.crs.units",self.crs.dimensions, self.crs.units)
